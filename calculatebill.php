...
if(isset($_POST['calculatebill']))
{
	...
	$bill=$_POST['bill_amt'];
			...
			$query="INSERT INTO `customer bill`(`cust_id`, `cust_expiry_date`, `month`, `unit_used`, `cust_bill`, `bill_number`, `cust_status`, `cust_penalty`,`total_bill`) VALUES ('$id','$expdate','$month','$unit','$bill','$custbillno','DUE','0','0')";
		$run=mysqli_query($con,$query);
		if($run){
			?>
									<?php
								  $message="
								  Dear $custname, your electricity bill has been generated. Details are given below:<br>
